...
assert.match(hub, /calibrationSvg\?\.getBoundingClientRect/);
...
assert.match(hub, /wall\.safePolygon\.forEach\(\(corner\) => \{\s*corner\.x \+= dx/);
assert.match(hub, /wall\.mountingZone\.forEach\(\(corner\) => \{\s*corner\.x \+= dx/);
