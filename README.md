...
- Startup now flows from the loading screen into a static Main Museum Hub.
  Calibrated artwork hotspots open the matching work in the existing gallery;
  the hub backgrounds are committed assets and work in Pages and `file://`
  preview modes.
