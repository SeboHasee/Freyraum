...
- Startup now flows from the loading screen into a static Main Museum Hub; its
  central artwork opens the existing interactive gallery without changing gallery controls.
