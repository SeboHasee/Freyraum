...
var Gp=Object.defineProperty;var Wp=(_n,wt,lt)=>wt in _n?Gp(_n,wt,{enumerable:!0,configurable:!0,writable:!0,value:lt}):_n[wt]=lt;var G=(_n,wt,lt)=>Wp(_n,typeof wt!="symbol"?wt+"":wt,lt);(function(){"use strict";var Jo,Qo;const _n=i=>i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;"),wt=({title:i,width:e,height:t,background:n,accent:r,secondary:s,horizonPercent:a=58})=>{const o=Math.max(e,t),l=Math.min(e,t),c=t*(a/100),h=e*.06,f=t*.92,d=o*.035,m=o*.004,v=o*.012,M=o*.005,p=l*.11,u=_n(i),b=`<svg xmlns="http://www.w3.org/2000/svg" width="${e}" height="${t}" viewBox="0 0 ${e} ${t}">
  <defs>
...
#endif`;const Le={alphahash_fragment:Hc,alphahash_pars_fragment:Vc,alphamap_fragment:Gc,alphamap_pars_fragment:Wc,alphatest_fragment:Xc,alphatest_pars_fragment:Yc,aomap_fragment:qc,aomap_pars_fragment:$c,batching_pars_vertex:Kc,batching_vertex:Zc,begin_vertex:jc,beginnormal_vertex:Jc,bsdfs:Qc,iridescence_fragment:eh,bumpmap_pars_fragment:th,clipping_planes_fragment:nh,clipping_planes_pars_fragment:ih,clipping_planes_pars_vertex:rh,clipping_planes_vertex:sh,color_fragment:ah,color_pars_fragment:oh,color_pars_vertex:lh,color_vertex:ch,common:hh,cube_uv_reflection_fragment:uh,defaultnormal_vertex:dh,displacementmap_pars_vertex:fh,displacementmap_vertex:ph,emissivemap_fragment:mh,emissivemap_pars_fragment:gh,colorspace_fragment:_h,colorspace_pars_fragment:vh,envmap_fragment:xh,envmap_common_pars_fragment:Mh,envmap_pars_fragment:Sh,envmap_pars_vertex:Eh,envmap_physical_pars_fragment:Uh,envmap_vertex:yh,fog_vertex:Th,fog_pars_vertex:bh,fog_fragment:Ah,fog_pars_fragment:wh,gradientmap_pars_fragment:Ch,lightmap_pars_fragment:Rh,lights_lambert_fragment:Ph,lights_lambert_pars_fragment:Lh,lights_pars_begin:Dh,lights_toon_fragment:Ih,lights_toon_pars_fragment:Nh,lights_phong_fragment:Fh,lights_phong_pars_fragment:Oh,lights_physical_fragment:Bh,lights_physical_pars_fragment:zh,lights_fragment_begin:kh,lights_fragment_maps:Hh,lights_fragment_end:Vh,logdepthbuf_fragment:Gh,logdepthbuf_pars_fragment:Wh,logdepthbuf_pars_vertex:Xh,logdepthbuf_vertex:Yh,map_fragment:qh,map_pars_fragment:$h,map_particle_fragment:Kh,map_particle_pars_fragment:Zh,metalnessmap_fragment:jh,metalnessmap_pars_fragment:Jh,morphinstance_vertex:Qh,morphcolor_vertex:eu,morphnormal_vertex:tu,morphtarget_pars_vertex:nu,morphtarget_vertex:iu,normal_fragment_begin:ru,normal_fragment_maps:su,normal_pars_fragment:au,normal_pars_vertex:ou,normal_vertex:lu,normalmap_pars_fragment:cu,clearcoat_normal_fragment_begin:hu,clearcoat_normal_fragment_maps:uu,clearcoat_pars_fragment:du,iridescence_pars_fragment:fu,opaque_fragment:pu,packing:mu,premultiplied_alpha_fragment:gu,project_vertex:_u,dithering_fragment:vu,dithering_pars_fragment:xu,roughnessmap_fragment:Mu,roughnessmap_pars_fragment:Su,shadowmap_pars_fragment:Eu,shadowmap_pars_vertex:yu,shadowmap_vertex:Tu,shadowmask_pars_fragment:bu,skinbase_vertex:Au,skinning_pars_vertex:wu,skinning_vertex:Cu,skinnormal_vertex:Ru,specularmap_fragment:Pu,specularmap_pars_fragment:Lu,tonemapping_fragment:Du,tonemapping_pars_fragment:Uu,transmission_fragment:Iu,transmission_pars_fragment:Nu,uv_pars_fragment:Fu,uv_pars_vertex:Ou,uv_vertex:Bu,worldpos_vertex:zu,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yt,depthTest:!1,depthWrite:!1})}function ro(){return new St({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ds(),fragmentShader:`
		...
		`,blending:Yt,depthTest:!1,depthWrite:!1})}function so(){return new St({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ds(),fragmentShader:`
...
#define LOW_PRECISION`),e}function of(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===js?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Js?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Wt&&(e="SHADOWMAP_TYPE_VSM"),e}function lf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Nn:case Fn:e="ENVMAP_TYPE_CUBE";break;case Ui:e="ENVMAP_TYPE_CUBE_UV";break}return e}function cf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Fn:e="ENVMAP_MODE_REFRACTION";break}return e}function hf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ta:e="ENVMAP_BLENDING_MULTIPLY";break;case Il:e="ENVMAP_BLENDING_MIX";break;case Nl:e="ENVMAP_BLENDING_ADD";break}return e}function uf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function df(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=of(t),c=lf(t),h=cf(t),f=hf(t),d=uf(t),m=Jd(t),v=Qd(s),M=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Ci).join(`
`)),a=Is(a),a=So(a,t),a=Eo(a,t),o=Is(o),o=So(o,t),o=Eo(o,t),a=yo(a),o=yo(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Li{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const ap=new Ja(-1,1,1,-1,0,1);class op extends pn{constructor(){super(),this.setAttribute("position",new nn([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new nn([0,2,0,0,2,0],2))}}const lp=new op;class zo{constructor(e){this._mesh=new Mt(lp,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,ap)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class cp extends Li{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof St?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=cr.clone(e.uniforms),this.material=new St({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new zo(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class ko extends Li{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const r=e.getContext(),s=e.state;s.buffers.color.setMask(!1),s.buffers.depth.setMask(!1),s.buffers.color.setLocked(!0),s.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),s.buffers.stencil.setTest(!0),s.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),s.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),s.buffers.stencil.setClear(o),s.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),s.buffers.color.setLocked(!1),s.buffers.depth.setLocked(!1),s.buffers.color.setMask(!0),s.buffers.depth.setMask(!0),s.buffers.stencil.setLocked(!1),s.buffers.stencil.setFunc(r.EQUAL,1,4294967295),s.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),s.buffers.stencil.setLocked(!0)}}class hp extends Li{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class up{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Se);this._width=n.width,this._height=n.height,t=new It(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Kt}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new cp(Bo),this.copyPass.material.blending=Yt,this.clock=new np}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let r=0,s=this.passes.length;r<s;r++){const a=this.passes[r];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(r),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}ko!==void 0&&(a instanceof ko?n=!0:a instanceof hp&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Se);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let s=0;s<this.passes.length;s++)this.passes[s].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class dp extends Li{constructor(e,t,n=null,r=null,s=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=s,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Ue}render(e,t,n){const r=e.autoClear;e.autoClear=!1;let s,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(s=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(s),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}}const fp={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Ue(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}di.BlurDirectionX=new Se(1,0),di.BlurDirectionY=new Se(0,1);class pp{constructor(e,t,n,r){G(this,"composer");G(this,"bloomPass");G(this,"handleResize",()=>{this.composer.setSize(window.innerWidth,window.innerHeight)});this.composer=new up(e);const s=new dp(t,n);this.composer.addPass(s),this.bloomPass=new di(new Se(window.innerWidth,window.innerHeight),r.bloomStrength,r.bloomRadius,r.bloomThreshold),this.bloomPass.enabled=r.bloomStrength>0,this.composer.addPass(this.bloomPass),window.addEventListener("resize",this.handleResize)}applyPreset(e){this.bloomPass.strength=e.bloomStrength,this.bloomPass.radius=e.bloomRadius,this.bloomPass.threshold=e.bloomThreshold,this.bloomPass.enabled=e.bloomStrength>0}render(){this.composer.render()}dispose(){window.removeEventListener("resize",this.handleResize),this.composer.dispose()}}class mp{constructor(e,t){G(this,"spotlight");G(this,"pointLight");G(this,"ambientLight");G(this,"animate",!0);this.ambientLight=new tp(16777215,1.5),e.add(this.ambientLight),this.spotlight=new Jf(16777215,150),this.spotlight.distance=80,this.spotlight.angle=.42,this.spotlight.penumbra=.9,this.spotlight.decay=1.8,this.spotlight.position.set(-10,5,7),this.spotlight.castShadow=t.shadows,e.add(this.spotlight),this.pointLight=new ep(16777215,8,30),this.pointLight.position.set(5,-2,6),e.add(this.pointLight)}applyPreset(e){this.spotlight.castShadow=e.shadows}setAnimated(e){this.animate=e}update(e){this.animate&&(this.spotlight.position.x=-10+Math.sin(e*2e-4)*.6)}dispose(){this.ambientLight.dispose(),this.spotlight.dispose(),this.pointLight.dispose()}}class gp{constructor(){G(this,"cache",new Map);G(this,"loader",new Zf);G(this,"maxAnisotropy",1);this.loader.setCrossOrigin("anonymous")}init(e){this.maxAnisotropy=e.capabilities.getMaxAnisotropy()}async preload(e){await Promise.all(e.map(t=>this.load(t)))}load(e){return this.cache.has(e)?Promise.resolve(this.cache.get(e)):new Promise(t=>{this.loader.load(e,n=>{this.prepareTexture(n),this.cache.set(e,n),t(n)},void 0,()=>{const n=this.createFallbackTexture(e);this.cache.set(e,n),t(n)})})}get(e){return this.cache.get(e)}dispose(){this.cache.forEach(e=>e.dispose()),this.cache.clear()}prepareTexture(e){e.colorSpace=Rt,e.anisotropy=this.maxAnisotropy,e.needsUpdate=!0}createFallbackTexture(e){const t=document.createElement("canvas");t.width=1600,t.height=1100;const n=t.getContext("2d");if(n){const s=this.hash(e)%32,a=n.createLinearGradient(0,0,t.width,t.height);a.addColorStop(0,`hsl(${205+s}, 18%, 92%)`),a.addColorStop(.55,`hsl(${35+s}, 22%, 78%)`),a.addColorStop(1,`hsl(${205+s}, 12%, 62%)`),n.fillStyle=a,n.fillRect(0,0,t.width,t.height),n.strokeStyle="rgba(255,255,255,0.34)",n.lineWidth=28,n.beginPath(),n.moveTo(t.width*.08,t.height*.28),n.bezierCurveTo(t.width*.35,t.height*.08,t.width*.58,t.height*.32,t.width*.9,t.height*.22),n.stroke(),n.fillStyle="rgba(17,24,29,0.16)",n.font="700 58px Inter, Arial, sans-serif",n.fillText("FREYRAUM",96,t.height-96)}const r=new Ro(t);return this.prepareTexture(r),r}hash(e){let t=0;for(let n=0;n<e.length;n+=1)t=t*31+e.charCodeAt(n)>>>0;return t}}class _p{constructor(){G(this,"normalTexture",null)}async loadNormalTexture(){if(this.normalTexture)return this.normalTexture;const e=document.createElement("canvas");e.width=128,e.height=128;const t=e.getContext("2d");if(!t){const a=new ht;return this.normalTexture=a,a}const n=t.createImageData(e.width,e.height),r=n.data;for(let a=0;a<e.height;a+=1)for(let o=0;o<e.width;o+=1){const l=Math.sin(o*.42)*10,c=Math.cos(a*.38)*10,h=Math.sin((o+a)*.11)*4,f=l+c+h,d=(a*e.width+o)*4;r[d]=128+f,r[d+1]=128-f,r[d+2]=255,r[d+3]=255}t.putImageData(n,0,0);const s=new Ro(e);return s.wrapS=mi,s.wrapT=mi,s.repeat.set(18,18),s.needsUpdate=!0,this.normalTexture=s,s}createArtworkMaterial(e,t){return new Fs({map:t!=null?t:null,normalMap:e,normalScale:new Se(.12,.12),roughness:.88,metalness:0,clearcoat:.04})}createFrameMaterial(){return new Fs({color:15196631,roughness:.52,metalness:.03,clearcoat:.18})}dispose(){var e;(e=this.normalTexture)==null||e.dispose()}}function Ho(i){const e=i.image;let t=1,n=1;return"naturalWidth"in e?(t=e.naturalWidth||e.width||1,n=e.naturalHeight||e.height||1):(t=e.width||1,n=e.height||1),{width:t,height:n,aspect:t/n}}function Vo(i,e,t){const n=Number.isFinite(i)&&i>0?i:1,r=e/t;return n>=r?{width:e,height:e/n}:{width:t*n,height:t}}class vp{constructor(e,t){G(this,"group");G(this,"frameMesh");G(this,"artworkMesh");G(this,"artworkMaterial");G(this,"frameMaterial");G(this,"canvasMaterial");G(this,"_artworkAspect",1);G(this,"_artworkWidth",4);G(this,"_artworkHeight",5.7);G(this,"currentSegments");G(this,"scene");this.scene=e,this.canvasMaterial=new _p,this.group=new Ri,this.currentSegments=t.artworkSegments;const n=new si(4.4,6.2,.18);this.frameMaterial=this.canvasMaterial.createFrameMaterial(),this.frameMesh=new Mt(n,this.frameMaterial),this.group.add(this.frameMesh);const r=new wn(4,5.7,this.currentSegments,this.currentSegments);this.artworkMaterial=new Fs({roughness:.88,metalness:0,clearcoat:.04}),this.artworkMesh=new Mt(r,this.artworkMaterial),this.artworkMesh.position.z=.095,this.group.add(this.artworkMesh),e.add(this.group),this.canvasMaterial.loadNormalTexture().then(s=>{this.artworkMaterial.normalMap=s,this.artworkMaterial.normalScale.set(.12,.12),this.artworkMaterial.needsUpdate=!0})}applyPreset(e){if(e.artworkSegments===this.currentSegments)return;this.currentSegments=e.artworkSegments;const t=this.artworkMesh.geometry,n=new wn(4,5.7,this.currentSegments,this.currentSegments);this.artworkMesh.geometry=n,t.dispose(),this.artworkMesh.scale.set(this._artworkWidth/4,this._artworkHeight/5.7,1)}updateAspect(e){const{aspect:t}=Ho(e);this._artworkAspect=t;const{width:n,height:r}=Vo(t,4.2,5.8);this._artworkWidth=n,this._artworkHeight=r,this.artworkMesh.scale.set(n/4,r/5.7,1);const s=n+.4,a=r+.4;this.frameMesh.scale.set(s/4.4,a/6.2,1)}setTexture(e){this.artworkMaterial.map=e,this.artworkMaterial.needsUpdate=!0,this.updateAspect(e)}get artworkAspect(){return this._artworkAspect}get artworkWidth(){return this._artworkWidth}get artworkHeight(){return this._artworkHeight}dispose(){this.scene.remove(this.group),this.frameMesh.geometry.dispose(),this.artworkMesh.geometry.dispose(),this.frameMaterial.dispose(),this.artworkMaterial.dispose(),this.canvasMaterial.dispose()}}class xp{constructor(e){G(this,"leftPanel");G(this,"rightPanel");G(this,"leftMaterial");G(this,"rightMaterial");G(this,"maxPreviewWidth",2.1);G(this,"maxPreviewHeight",2.9);const t=new wn(1,1);this.leftMaterial=new Ai({transparent:!0,opacity:.95}),this.leftPanel=new Mt(t,this.leftMaterial),this.leftPanel.position.set(-4.9,0,-1.1),this.leftPanel.rotation.y=.28,this.leftPanel.userData.side="left",e.add(this.leftPanel),this.rightMaterial=new Ai({transparent:!0,opacity:.95}),this.rightPanel=new Mt(t,this.rightMaterial),this.rightPanel.position.set(4.9,0,-1.1),this.rightPanel.rotation.y=-.28,this.rightPanel.userData.side="right",e.add(this.rightPanel)}updateTextures(e,t){e&&(this.leftMaterial.map=e,this.leftMaterial.needsUpdate=!0,this.updatePanelScale(this.leftPanel,e)),t&&(this.rightMaterial.map=t,this.rightMaterial.needsUpdate=!0,this.updatePanelScale(this.rightPanel,t))}getMeshes(){return[this.leftPanel,this.rightPanel]}dispose(){this.leftPanel.geometry.dispose(),this.rightPanel.geometry.dispose(),this.leftMaterial.dispose(),this.rightMaterial.dispose()}updatePanelScale(e,t){const{aspect:n}=Ho(t),{width:r,height:s}=Vo(n,this.maxPreviewWidth,this.maxPreviewHeight);e.scale.set(r,s,1)}}function Dn(i,e,t){return Math.max(e,Math.min(t,i))}const mr=7,Go=8.5,Wo=1.2,Xo=.28,Yo=.92;class Mp{constructor(e,t,n,r){G(this,"currentIndex",0);G(this,"artworkMesh");G(this,"sidePanels");G(this,"textureManager");G(this,"camera");G(this,"raycaster",new ip);G(this,"reducedMotion",!1);G(this,"targetX",0);G(this,"targetY",0);G(this,"zoom",mr);G(this,"targetZoom",mr);G(this,"panX",0);G(this,"panY",0);G(this,"targetPanX",0);G(this,"targetPanY",0);G(this,"onNavigateCallback",null);this.artworkMesh=e,this.sidePanels=t,this.textureManager=n,this.camera=r}async init(){const e=lt.map(t=>t.image);await this.textureManager.preload(e),this.showArtwork(0)}addZoomDelta(e){this.targetZoom=this.clampZoom(this.targetZoom+e),this.clampPanTargets()}setPanOffset(e,t){const{x:n,y:r}=this.getPanLimits(this.targetZoom);this.targetPanX=Dn(this.targetPanX+e,-n,n),this.targetPanY=Dn(this.targetPanY+t,-r,r)}canPan(){const{x:e,y:t}=this.getPanLimits(this.targetZoom);return e>.01||t>.01}getHoverRotationScale(){const e=Math.max(.001,Go-this.getMinZoom()),t=(this.clampZoom(this.targetZoom)-this.getMinZoom())/e;return{x:.03+t*.13,y:.018+t*.062}}showArtwork(e){var l,c;const t=lt[e],n=this.textureManager.get(t.image);n&&this.artworkMesh.setTexture(n);const r=(e-1+lt.length)%lt.length,s=(e+1)%lt.length,a=(l=this.textureManager.get(lt[r].image))!=null?l:null,o=(c=this.textureManager.get(lt[s].image))!=null?c:null;this.sidePanels.updateTextures(a,o),this.targetZoom=this.clampZoom(this.targetZoom),this.zoom=this.clampZoom(this.zoom),this.clampPanTargets()}navigate(e){var n;const t=Dn((this.currentIndex+e+lt.length)%lt.length,0,lt.length-1);this.reducedMotion||(this.artworkMesh.group.position.x=e*3.2,this.artworkMesh.group.rotation.y=e*.32,this.artworkMesh.group.scale.set(.84,.84,.84)),this.currentIndex=t,this.showArtwork(t),this.resetView(),(n=this.onNavigateCallback)==null||n.call(this,this.currentIndex)}goTo(e){var r;if(e===this.currentIndex)return;const t=e>this.currentIndex?1:-1,n=e-this.currentIndex;this.currentIndex=e,this.reducedMotion||(this.artworkMesh.group.position.x=(n>0?1:-1)*3.2,this.artworkMesh.group.rotation.y=t*.32,this.artworkMesh.group.scale.set(.84,.84,.84)),this.showArtwork(e),this.resetView(),(r=this.onNavigateCallback)==null||r.call(this,this.currentIndex)}setReducedMotion(e){this.reducedMotion=e}setHoverTarget(e,t){this.targetY=e,this.targetX=t}onNavigate(e){this.onNavigateCallback=e}get index(){return this.currentIndex}get artworkAspect(){return this.artworkMesh.artworkAspect}handlePanelClick(e,t){const n=t.getBoundingClientRect(),r=new Se((e.clientX-n.left)/n.width*2-1,-((e.clientY-n.top)/n.height)*2+1);this.raycaster.setFromCamera(r,this.camera);const s=this.sidePanels.getMeshes(),a=this.raycaster.intersectObjects(s);if(a.length>0){const o=a[0].object.userData.side;o==="left"?this.navigate(-1):o==="right"&&this.navigate(1)}}update(){const e=this.artworkMesh.group;this.targetZoom=this.clampZoom(this.targetZoom),this.clampPanTargets(),e.rotation.x+=(this.targetX-e.rotation.x)*.05,e.rotation.y+=(this.targetY-e.rotation.y)*.05,e.position.x+=(0-e.position.x)*.06,e.position.y+=(0-e.position.y)*.06,e.scale.x+=(1-e.scale.x)*.06,e.scale.y+=(1-e.scale.y)*.06,e.scale.z+=(1-e.scale.z)*.06,this.zoom+=(this.targetZoom-this.zoom)*.08,this.camera.position.z+=(this.zoom-this.camera.position.z)*.08,this.panX+=(this.targetPanX-this.panX)*.08,this.panY+=(this.targetPanY-this.panY)*.08,this.camera.position.x+=(this.panX-this.camera.position.x)*.08,this.camera.position.y+=(this.panY-this.camera.position.y)*.08}resetView(){this.targetPanX=0,this.targetPanY=0,this.targetZoom=this.clampZoom(mr),this.targetX=0,this.targetY=0}clampZoom(e){return Dn(e,this.getMinZoom(),Go)}clampPanTargets(){const e=this.getPanLimits(this.targetZoom);this.targetPanX=Dn(this.targetPanX,-e.x,e.x),this.targetPanY=Dn(this.targetPanY,-e.y,e.y)}getPanLimits(e){const t=2*this.clampZoom(e)*Math.tan(Ma.degToRad(this.camera.fov*.5)),n=t*this.camera.aspect;return{x:Math.max(0,(this.artworkMesh.artworkWidth-n)*.5*Yo),y:Math.max(0,(this.artworkMesh.artworkHeight-t)*.5*Yo)}}getMinZoom(){const t=Math.max(this.artworkMesh.artworkHeight*Xo,this.artworkMesh.artworkWidth*Xo/this.camera.aspect)/(2*Math.tan(Ma.degToRad(this.camera.fov*.5)));return Dn(Math.max(Wo,t),Wo,mr)}}class Sp{constructor(e){G(this,"el");this.el=document.createElement("header"),this.el.className="topbar",this.el.setAttribute("role","banner"),this.el.innerHTML=`
