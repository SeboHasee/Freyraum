...
3. Confirm whether behavior is expected under current startup mode/config.
4. If behavior differs from docs, treat as drift and update canonical docs in the same fix PR.
