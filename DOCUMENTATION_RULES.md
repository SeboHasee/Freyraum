...
- 2026-05-19: v0.15 animation enhancement planning documented. `plan.md` now defines a research-backed motion system plan for smoother, longer, more elegant animations; `FINDINGS.md` records 2026 accessibility/performance guidance and current motion-code audit results. No runtime code was changed.
